...
<body>
		...
		<tbody>
			<tr>
				...
				<?php 
						$id = $row['id'];
				?>
				<form name="formularioReducir" method="post" action="http://localhost:8080/tecnologiasweb/practicas/softwareProject/backend/reducirStockQuimica.php">
							<input type = "hidden"name="id" id="form-name" value="<?= $id ?>">
							<td><input name="boton" type="submit" value="Reducir">			
				</form>
				<form name="formularioAumentar" method="post" action="http://localhost:8080/tecnologiasweb/practicas/softwareProject/backend/aumentarStockQuimica.php">
					<input type = "hidden"name="id" id="form-name" value="<?= $id ?>">
	...
	<form method="post" action="http://localhost:8080/tecnologiasweb/practicas/softwareProject/backend/agregarProductoQuimica.php">
