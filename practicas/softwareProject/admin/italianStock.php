...
$stock = "SELECT * FROM italianStock where eliminado = 0";
...
<body>
		...
		<tbody>
			<tr>
				...
				<?php 
						$id = $row['id'];
				?>
				<form name="formularioReducir" method="post" action="http://localhost:8080/tecnologiasweb/practicas/softwareProject/backend/reducirStockItalian.php">
							<input type = "hidden"name="id" id="form-name" value="<?= $id ?>">
							<td><input name="boton" type="submit" value="Reducir">			
				</form>
				<form name="formularioAumentar" method="post" action="http://localhost:8080/tecnologiasweb/practicas/softwareProject/backend/aumentarStockItalian.php">
					<input type = "hidden"name="id" id="form-name" value="<?= $id ?>">
					<td><input name="boton" type="submit" value="aumentar">
				</form>
						
				<form name="formularioEliminar" method="post" action="http://localhost:8080/tecnologiasweb/practicas/softwareProject/backend/eliminarProductoItalian.php">
					<input type = "hidden"name="id" id="form-name" value="<?= $id ?>">
	...
	<form method="post" action="http://localhost:8080/tecnologiasweb/practicas/softwareProject/backend/agregarProductoItalian.php">
