...
$stock = "SELECT * FROM arquitecturaStock where eliminado = 0";
		...
		<tbody>
			<tr>
				...
				<?php 
						$id = $row['id'];
				?>
				<form name="formularioReducir" method="post" action="http://localhost:8080/tecnologiasweb/practicas/softwareProject/backend/reducirStockArquitectura.php">
							<input type = "hidden"name="id" id="form-name" value="<?= $id ?>">
							<td><input name="boton" type="submit" value="Reducir">			
				</form>
				<form name="formularioAumentar" method="post" action="http://localhost:8080/tecnologiasweb/practicas/softwareProject/backend/aumentarStockArquitectura.php">
					<input type = "hidden"name="id" id="form-name" value="<?= $id ?>">
					<td><input name="boton" type="submit" value="aumentar">
				</form>
						
				<form name="formularioEliminar" method="post" action="http://localhost:8080/tecnologiasweb/practicas/softwareProject/backend/eliminarProductoArquitectura.php">
					<input type = "hidden"name="id" id="form-name" value="<?= $id ?>">
